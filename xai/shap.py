...
print(np.transpose(shap_values, (2, 0, 1))[0].shape)
print(X_test.shape)
print(shap_values)
print(shap_values[0, :, 1]) # for values
print(explainer.expected_value)
print(shap_values[0][0][1]) # for values
...
# Feature summary
shap.summary_plot(np.transpose(shap_values, (2, 0, 1))[1], X_test)
